...
let jobs: array<job> = [
  ...
  mk(
    ...
    "Tuesday night at the Dawes barn, and the simulator is furniture: trucks up the drive, the percolator already going, one roll call in full ceremony — rehearsal two thousand eight hundred and six — and then the evening's real business: the crew tries the case against this week's parade-winning astronaut, Stitch prosecuting. Taillights, padlock, dark house.",
    [V14Cast.cricket, V14Cast.dutch, V14Cast.stitch, V14Cast.gunny],
    "four old friends gather at the barn, open their fifty-year ritual with a roll call, and spend the evening arguing about a real astronaut's landing",
    "pure character: the audience leaves loving four distinct men and knowing the fifty years from one spoken number — the ritual is set dressing, the friendship is the scene, and the skill is CLAIMED, never demonstrated, because the movie itself will do the demonstrating",
    [
      {
        who: "GUNNY",
        ...
        turn: "his roll call opens the night with full ceremony — 'Apollo Eighteen. Lunar descent rehearsal. Number two thousand, eight hundred and six.' — the solemnity at that scale is the joke and nobody laughs; his attempts to keep the case orderly fail all evening; he closes the net formally anyway — 'Net closed. Same time Tuesday.' / 'God willing.'",
        subtext: "ceremony as love; the number is the fifty years, said without saying it",
      },
      {
        who: "STITCH",
        want: "to try the case against this week's parade-winning astronaut — a real, current mission's landing they all watched on the news — as prosecutor, star witness, and jury",
        wall: "Dutch, who has the actual figures written down, with dates",
        turn: "he prosecutes: the computer flew it, the landing came in long, 'and that fella's got a patch on his arm and a parade in Houston' — his numbers round upward as he goes, he invents tall-tale rules of evidence when caught, doubles down with total conviction, and wins the room anyway",
        subtext: "retired varsity trying the league that forgot them; wonder wearing a prosecutor's suit",
      },
      {
        who: "DUTCH",
        want: "the record correct, even in a kangaroo court",
        wall: "the correction never changes the verdict",
        turn: "he corrects Stitch's figure from his ledger — with the date he wrote it down — the correction is accepted into evidence and changes nothing, and Dutch joins the unanimous verdict anyway: not one of those boys would have cleared his physical",
        subtext: "accuracy as devotion; even his dissents are votes for the crew",
      },
      {
        who: "CRICKET",
        ...
        turn: "'You slept out here again.' gets deflected with an operational fact and not answered; all evening he is the flat center — he adjudicates one disputed point with a single sentence and it lands like a gavel; when the verdict comes in he neither joins nor objects, which the crew correctly reads as concurrence",
        subtext: "the widower texture arrives as inference; his stillness is the room's anchor",
      },
    ],
    [
      "THE SIMULATOR IS FURNITURE — this is a hard law from the director. NO operational drill content of any kind: no descent, no readouts, no altitude calls, no instrument faults, no kicks, no contact light, no landing, no critique of any landing by anyone in this barn. The simulator appears ONLY as: its hum under the room, the logbook wall, Gunny's roll call, and the net-closed line. Anyone caught flying anything in this scene has failed the seed.",
      "SHORT — two screenplay pages, no more. Structure: trucks up the drive (headlights across the wall, three engines, three gaits, greetings by name); the percolator beat ('You slept out here again.'); the roll call in full ceremony; THE CASE — the evening's main event, pure talk, Stitch prosecuting this week's real astronaut with Dutch's ledger against him and Gunny failing to keep order and Cricket flat in the middle; then 'Net closed. Same time Tuesday.' / 'God willing.'; taillights down the drive one by one, the padlock's single pull, and the farmhouse beyond with no lights on inside.",
      "OPEN on the trainer briefly per the style doctrine — the pull-cord CLICK, the APOLLO PROCEDURES TRAINER standing in half the barn, the logbook wall from 1972 — established as FURNITURE in four lines or fewer, then the scene belongs to the men. The room is half flight facility, half clubhouse, and nobody sees a contradiction.",
      "CIVILIAN LEGIBILITY, once: the roll call names the mission and the count — Apollo Eighteen, lunar descent rehearsal, number two thousand, eight hundred and six — and that is ALL the scene ever explains. The audience does the math on the fifty years.",
      "THE CASE is the scene's engine: specific, technical, personally affronted, played dead straight — and the skill it implies is CLAIMED, never demonstrated. The scene never argues with their arrogance and never proves it either; the movie will do the proving.",
