/* THE FOUR OLDS — dialogue-lift pass for the Sky King first-telling scene.
   Run: CLAUDE_STUDIO_BUDGET=6 node src/FourOlds_LiftSkyKing1.res.mjs */
let path = Cinema_Backends.Path(
  "/Users/dusty/Dev/metaphrand/.claude/worktrees/rosca-pitch/stories/four-olds/draft/engine_sky_king_1.scene.txt",
)
